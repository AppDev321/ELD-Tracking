        ...
        implements TrackerUpdateProgressFragment.OnTrackerUpdateClosedListener, FragmentManager.OnBackStackChangedListener
{
    ...
    protected void onServiceBound(final TrackerService.TrackerBinder binder) {
        ...
        // Verify if the TUPF is present but the update is over
        if (!mTrackerBinder.getTracker().isUpdating()) {
            FragmentManager fm = getSupportFragmentManager();
            Log.i(TAG, "A:Fragments count="+fm.getFragments().size());
            Fragment fragment = fm.findFragmentByTag(TrackerUpdateProgressFragment.FRAG_TAG);
            if (fragment != null) {
                Log.i(TAG, "A:Dismiss TUPF");
                TrackerUpdateProgressFragment df = (TrackerUpdateProgressFragment) fragment;
                df.dismiss();
            }
        }
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        setContentView(com.pt.devicemanager.R.layout.activity_tracker_manager);
        Toolbar toolbar = findViewById(com.pt.devicemanager.R.id.toolbar);
...
//        getSupportActionBar().setDisplayUseLogoEnabled(true);
        ...
        // Dont need drawer
        final DrawerLayout drawer = findViewById(com.pt.devicemanager.R.id.drawer_layout);
...
//        NavigationUI.setupWithNavController(navigationView, navController);
        ...
        if (savedInstanceState == null) {
            ...
            if (AppModel.MODE_USB) {
                ft.add(com.pt.devicemanager.R.id.fragment_container, DevicesFragment.newInstance(), DevicesFragment.FRAG_TAG);
            } else {
                ft.add(com.pt.devicemanager.R.id.fragment_container, DefaultFragment.newInstance());
            }
            ft.commit();
        }
    }
    ...
    void getPrivacyConsent(final Activity activity, final SharedPreferences sharedPreferences)
    {
        ...
        mPrivacyDlg.setContentView(com.pt.devicemanager.R.layout.privacy_notice);
        ...
        TextView link = (TextView) mPrivacyDlg.findViewById(com.pt.devicemanager.R.id.privacy_link);
        link.setMovementMethod(LinkMovementMethod.getInstance());

        SwitchCompat modeUsb = mPrivacyDlg.findViewById(com.pt.devicemanager.R.id.switchUsb);

        Button accept = mPrivacyDlg.findViewById(com.pt.devicemanager.R.id.privacy_accept);
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (modeUsb.isChecked()) {
                    ...
                    FragmentManager fm = getSupportFragmentManager();
                    Fragment fragment = fm.findFragmentById(com.pt.devicemanager.R.id.fragment_container);
                    if (fragment != null) {
                        FragmentTransaction ft = fm.beginTransaction();
                        ft.replace(com.pt.devicemanager.R.id.fragment_container, DevicesFragment.newInstance(), DevicesFragment.FRAG_TAG);
                        ft.commit();
                    }
    ...
    protected int getConnectionToggleResourceId() {
        return com.pt.devicemanager.R.id.fab;
    }
    ...
    synchronized public void onDeviceConnecting(BluetoothDevice device) {
        ...
        if (fm.findFragmentByTag(TrackerConnectingFragment.FRAG_TAG) == null) {
            ...
            ft.replace(com.pt.devicemanager.R.id.fragment_container, tcf, TrackerConnectingFragment.FRAG_TAG);
            ft.commit();
        } else {
...
//        }
            ...
            ft.replace(com.pt.devicemanager.R.id.fragment_container, tvf, TrackerViewFragment.FRAG_TAG);
            ft.commit();
        } else {
    ...
    public void onDeviceDisconnecting(final BluetoothDevice device) {
        ...
        if (fragment != null) {
            ...
            ft.replace(com.pt.devicemanager.R.id.fragment_container,df,DefaultFragment.FRAG_TAG );
            ft.commit();
        }
    }
