...
import com.dopsi.webapp.databinding.FragmentCertifyBinding
...
@AndroidEntryPoint
class CertifyFragment : BaseFragment<FragmentCertifyBinding>(FragmentCertifyBinding::inflate),
    ItemClickListener {

    override fun initUserInterface(view: View?) {

    viewDataBinding.btnClearSignature.setOnSingleClickListener{
        viewDataBinding.signaturePad.clear()
    }
    ...
    override fun onResume() {
        ...
        activity?.let {
            ...
            it.supportActionBar?.title = "Certify"
        }
